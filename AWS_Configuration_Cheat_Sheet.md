...
4. Set the _bucket_name_. This can be found by searching for the S3 Storage service. Click the link for the elasticbeanstalk bucket that matches your region code and copy the name.

eg: 'elasticbeanstalk-us-east-1-923445599289'

5. Set the _bucket_path_ to 'docker'

6. Set _access_key_id_ to $AWS_ACCESS_KEY

7. Set _secret_access_key_ to $AWS_SECRET_KEY
...
git push origin main 3. Go to your Travis Dashboard and check the status of your build.
```
